...
public class Messages {
    ...
    public static final String BUTTON_SELECTED_All = "button.selected_all";
    public static final String BUTTON_SELECTED_REVERSE = "button.selected_reverse";
    public static final String BUTTON_SELECTED_NO = "button.selected_no";
    public static final String BUTTON_CREATE_PDF = "button.create_pdf";
    public static final String BUTTON_CLEAN = "button.clean";
    ...
    public static final String TITLE_TSCAN_MANAGER = "title.tscan_manager";
