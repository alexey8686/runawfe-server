 ...
 *
 * @struts:action path="/submitMultipleTaskForm" name="multipleProcessForm" validate="true"
...
public class SubmitMultipleTaskFormAction extends BaseMultipleProcessFormAction {
  ...
  @Override
  @Transactional
  protected Long [] executeProcessFromActions(HttpServletRequest request, ActionForm actionForm, ActionMapping mapping, Profile profile) {
    User user = getLoggedUser(request);
    MultipleProcessForm multipleProcessForm = (MultipleProcessForm) actionForm;
    List<ProcessForm> forms = JsonConverter.getFormList(new ProcessForm(),multipleProcessForm.getMultipartRequestHandler(), multipleProcessForm.getId());
